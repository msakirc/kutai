...
Durable, append-only cross-mission lesson history (the events/history pillar
of kara_kutu). Public helpers:
...
Schema (mission_lessons table) is registered via dabidabi.

CLI entry:
  python -m kara_kutu.mission_lessons emit-dlq
"""
...
logger = get_logger("kara_kutu.mission_lessons")
...
if __name__ == "__main__":
    ...
    if cmd == "emit-dlq":
        ...
        print("Usage: python -m kara_kutu.mission_lessons emit-dlq")
        sys.exit(1)
