"""Tests for salako.parse_og_tags — the meta-tag verifier verb.
...
``salako.parse_og_tags._fetch`` so the suite stays hermetic.
"""
...
og_mod = importlib.import_module("salako.parse_og_tags")
from salako.parse_og_tags import _extract_meta, parse_og_tags
import salako
