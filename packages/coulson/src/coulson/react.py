    ...
    try:
      ...
      for iteration in range(effective_max_iterations):
        ...
        if action_type == "final_answer":
            ...
            # SP3b Task 7: self_reflect is now a Beckman post-hook child task
            # (wired in posthooks.determine_posthooks). The inline block was
            # removed here; behaviour is preserved via the post-hook chain.
        ...
        if action_type == "tool_call":
            ...
            if (
                ...
                if cached is not None:
                    ...
                    try:
                        from src.infra.metrics import record_tool_call
                    ...
                    if tool_name in SIDE_EFFECT_TOOLS:
                        ...
                        if tool_name in ("write_file", "edit_file", "patch_file", "apply_diff"):
                            ...
                            if _target_file:
                                try:
                                    from src.parsing.code_embeddings import post_tool_reindex
