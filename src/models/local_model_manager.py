...
# Local-load context sizing is KutAI policy — see src/models/context_sizing.py.
# DaLLaMa stays a generic loader; ensure_model passes need_ctx() result as a
# plain ServerConfig.context_length.
from .context_sizing import need_ctx as _need_ctx
