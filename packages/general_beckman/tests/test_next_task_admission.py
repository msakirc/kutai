...
async def test_holds_when_depleted_and_low_priority():
    """After 2026-04-30 pressure-gate consolidation: selector owns the
    threshold check. Beckman just trusts the result. Low-priority depleted
    scenario surfaces as `select() returns None` from the selector."""
    import general_beckman
