...
def _get_convention_context() -> str:
    ...
    try:
        import tools.workspace as _ws
        from tools.codebase_index import build_index, detect_conventions, get_cached_index
...
def _get_codebase_map_context() -> str:
    ...
    try:
        import tools.workspace as _ws
        from tools.codebase_index import build_index, get_cached_index, get_codebase_map
